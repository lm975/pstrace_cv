...
class CVParams:
    # CV parameters
    E_begin_mV: float = -500.0
    Vertex1_mV: float = +1100
    Vertex2_mV: float = -500
    Step_mV: float = 10
...
def main():
    ...
    mscript_text = build_single_scan_cv_mscript_minimal(params)
    mscript_path = os.path.join(OUTPUT_PATH, "cv_generated_single_scan.mscr")
